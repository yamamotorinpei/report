...
create table match ( id int auto_increment not null primary key, year int, player_id int, team_id int, OV int, TV int, WR );
...
load data local infile 'match.csv' into table batting fields terminated by ',' enclosed by '"';
